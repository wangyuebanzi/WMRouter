...
import com.foolman.demolib2api.services.IFactoryService;
 ...
 */
@RouterUri(path = com.sankuai.waimai.router.demo.constants.Constant.SERVICE_LOADER)
public class ServiceLoaderActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        s.append(com.foolman.testapi.constants.Constant.TEST_FRAGMENT + "实现类:\n");
        Class<Fragment> fragmentClass = Router.getServiceClass(Fragment.class,
                com.foolman.testapi.constants.Constant.TEST_FRAGMENT);

        Fragment service5 = Router.getService(Fragment.class, com.foolman.testapi.constants.Constant.TEST_FRAGMENT);
        ...
        IAccountService accountService1 = Router.getService(IAccountService.class,
                com.foolman.common.constants.Constant.SINGLETON);
        ...
        // 方法调用
        s.append("MethodCall:\n");
        Integer result = Router.callMethod(com.foolman.common.constants.Constant.ADD_METHOD, 1, 2);
        s.append("1 + 2 = ").append(result).append('\n');
        Integer versionCode = Router.callMethod(com.foolman.common.constants.Constant.GET_VERSION_CODE);
        s.append("version = ").append(versionCode).append('\n');
        s.append('\n');

        // Kotlin
        Object service = Router.getService(Object.class, Constant.KOTLIN_SERVICE);
