package com.foolman.login.services;
 ...
 */
@RouterService(interfaces = IAccountService.class, key = com.foolman.common.constants.Constant.SINGLETON, singleton = true)
public class FakeAccountService implements IAccountService {
    ...
    public void startLogin(Context context) {
        Router.startUri(context, Constant.LOGIN);
    }
